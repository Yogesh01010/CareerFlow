            ...
            <form onSubmit={onSubmitHandler} className='relative bg-white p-10 rounded-xl text-slate-500' action="">
                ...
                {state === 'Sign Up' && isTextDataSubmited
                    ...
                    : <>
                        ...
                        {state !== 'Login' && (
                            <div className='border border-gray-100 px-4 py-2 flex items-center gap-2 roundedfull mt-5'>
...

                {
                    state === 'Login'
                        ...
                        : <p className='mt-5 text-center'>Already have account? <span className='text-blue-600 cursor-pointer' onClick={() => setState('Login')}>Login</span></p>
                }
