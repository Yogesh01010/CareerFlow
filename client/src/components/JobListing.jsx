...
const JobListing = () => {
    ...
    const [selectedLocations, setSelectedLocatons] = useState([]);
  ...
  return (
    <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8 '>
        ...
        <div className='w-full lg:w-1/4 bg-white px-4'>
            ...
            {/* Search Filter frm hero component */}
            {
            ...
            <button onClick={e=> setShowFilter(prev => !prev)} className='px-6 py-1.5 rounded border border-gray-300 lg:hidden '>
        ...
        <section className='w-full lg:w-3/4 text-gray-800 max-lg:px-4'>
            ...
            <p className=''>Get your desired job from top companies</p>
